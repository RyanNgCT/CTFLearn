...
After unzipping the `zip` file, I found that the resultant folder was empty (oe was it 👀)... 

![incorrect_flag]()

Some knowledge in git made me suspect they were hidden directories and files (i.e. using the `.` prefix). Using [this article](https://git-scm.com/book/en/v2/Git-Basics-Viewing-the-Commit-History), we can gain some inspiration of how to extract the contents of the commit. 
